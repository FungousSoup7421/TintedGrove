...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void registerWoodSet(TintedColor color) {
        ...
        blockWithItem(ModBlocks.getPlank(color));

        stairsBlock(ModBlocks.getWoodStairs(color).get(), blockTexture(ModBlocks.getPlank(color).get()));
        slabBlock(ModBlocks.getWoodSlab(color).get(),
                blockTexture(ModBlocks.getPlank(color).get()),
                blockTexture(ModBlocks.getPlank(color).get()));

        buttonBlock(ModBlocks.getWoodButton(color).get(), blockTexture(ModBlocks.getPlank(color).get()));
        pressurePlateBlock(ModBlocks.getWoodPressurePlate(color).get(), blockTexture(ModBlocks.getPlank(color).get()));
        fenceBlock(ModBlocks.getWoodFence(color).get(), blockTexture(ModBlocks.getPlank(color).get()));
        fenceGateBlock(ModBlocks.getWoodFenceGate(color).get(), blockTexture(ModBlocks.getPlank(color).get()));
